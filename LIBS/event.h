...
extern char freeze_gui_on_exit; //1 - po opusteni udalosti cela cesta uzamcena
...
#define TASK_GET_gui_terminate() ((task_info[cur_task] & TASK_TERMINATING)!=0)
